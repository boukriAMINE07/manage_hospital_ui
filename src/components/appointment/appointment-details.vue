  ...
  <div class="row">
      ...
      <div class="card">
        <div class="card-body">
          <div class="media d-sm-flex d-block text-center text-sm-start pb-4 mb-4 border-bottom">
            <img v-if="appointment.patient.gender==='MALE'" alt="image" class="rounded me-sm-4 me-0" width="130" src="../../../public/assets/images/avatar/1.jpg">
            <img v-else alt="image" class="rounded me-sm-4 me-0" width="130" src="../../../public/assets/images/avatar/2.jpg">
            <div class="media-body align-items-center">
              <div class="d-sm-flex d-block justify-content-between my-3 my-sm-0">
                <div>
                  <h3 class="fs-22 text-black font-w600 mb-0">{{appointment.patient.name}} </h3>

                  <p class="mb-2 mb-sm-2">
                    &nbsp; <i class="fa fa-calendar-alt fa-2x"></i>
                    <span class="fs-5">&nbsp;{{appointment.patient.birthdate}}</span>
                  </p>


                </div>
                <span>#&nbsp;{{appointment.patient.id}}</span>
                <h3> <span :class="badgeClasses[appointment.statusAppointment]" >&nbsp; <strong>{{appointment.statusAppointment}}</strong> </span></h3>
              </div>
              <a v-if="appointment.patient.gender==='MALE'" href="javascript:void(0);" class="btn bgl-primary btn-rounded text-black mb-2 me-2">
              ...
              <a v-else href="javascript:void(0);" class="btn bgl-primary btn-rounded text-black mb-2 me-2" >
                <svg class="me-2 scale5" width="14" height="14" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <text x="6" y="20"  fill="#FF69B4" font-size="36px" style="font-weight: bold;">♀</text>
                </svg>
                Female
              </a>
          ...
          <div class="row">
            <div class="col-lg-6 mb-2">
              <div class="media">
                ...
                <div class="media-body">
                  <span class="d-block text-dark mb-2">Address</span>
                  <p class="fs-18 text-dark">{{appointment.patient.address}} </p>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="map-bx mb-2">
                <img src="../../../public/assets/images/svg/map.svg" alt="">
            ...
            <div class="col-lg-6 mb-md-0 mb-2">
              <div class="media">
                ...
                <div class="media-body">
                  <span class="d-block text-dark mb-2">Phone</span>
                  <p class="fs-18 text-dark font-w600 mb-0">+212 {{appointment.patient.phone}}</p>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="media">
                ...
                <div class="media-body">
                  <span class="d-block text-dark mb-2">Email</span>
                  <p class="fs-18 text-dark font-w600 mb-0">{{appointment.patient.email}}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="media d-sm-flex text-sm-start d-block text-center">
            <img  v-if="appointment.doctor.gender==='FEMALE'" src="../../../public/assets/images/nurse.jpg" alt="image" class="rounded me-sm-4 me-0 mb-2 mb-sm-0" width="130">
            <img v-else src="../../../public/assets/images/doctor_Male.jpg" alt="image" class="rounded me-sm-4 me-0 mb-2 mb-sm-0" width="130" >

            <div class="media-body">
              <h3 class="fs-22 text-black font-w600">Dr. {{appointment.doctor.name}}</h3>
              <p class="text-primary">{{appointment.doctor.speciality}}</p>
              <p class="fs-18 text-dark font-w600 mb-0">+212 {{appointment.doctor.phone}}</p>

              <div class="social-media mb-sm-0  mb-3 mt-2 justify-content-sm-start justify-content-center">
                <a href="javascript:void(0);" class="text-primary"><strong>{{appointment.doctor.email}}</strong> </a>
    ...
    <div class="col-xl-12 col-xxl-12">
      <div class="card patient-detail">
        ...
        <div v-if="appointment.consultation!=null" class="card-body fs-14 font-w300">
              {{appointment.consultation.rapport}}
        </div>
        <div v-else class="card-body fs-14 font-w300">
          No note for this patient
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      badgeClasses: {
        WAITING  : 'badge light badge-warning',
        CONFIRMED : 'badge light badge-success',
        CANCELED : 'badge light badge-danger',
      },
    };
  },
  methods:{
