            ...
            <ul class="navbar-nav header-right">
              ...
              <li class="nav-item dropdown header-profile">
                <a class="nav-link" href="javascript:;" role="button" data-bs-toggle="dropdown">
                  <img src="../../public/assets/images/profile/12.png" width="20" alt=""/>
    ...
    <div class="deznav">
      <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
          <li>
            <router-link class="has-arrow ai-icon"  to="/" >
            <i class="flaticon-381-networking"></i>
            <span class="nav-text">Dashboard</span>
          </router-link>
          </li>
          <li><router-link  to="/appointments" exact-active-class="active" class="">
            <i class="flaticon-381-menu"></i>
            <span class="nav-text">Appointment</span>
          </router-link>
          </li>
          <li><router-link to="/doctors" exact-active-class="active" class="" >
            <i class="flaticon-381-id-card-4  "></i>
            <span class="nav-text">Doctors</span>
          </router-link>
          </li>
          <li><router-link to="/administrators" exact-active-class="active" class="" >
            <i class="flaticon-381-settings-2 "></i>
            <span class="nav-text">Administrators</span>
          </router-link>
          </li>
          <li><router-link to="/consultations" exact-active-class="active" class="" >
          ...
          <li>
            <router-link to="/patients"  class=""  >
            <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
