<template>
  ...
  <div class="row">
    <div class="col-xl-3 col-xxl-3 col-sm-6">
      <router-link to="/patients" class="card card-wr  gradient-bx text-white bg-danger rounded ">
        <div class="card-body">
          <div class="media align-items-center">
            <div class="media-body">
              <p class="mb-1">Total Patient</p>
              <div class="d-flex flex-wrap">
                <h2 class="fs-40 font-w600 text-white mb-0 me-3">{{ patientLength }}</h2>
                <div>
                  <svg width="28" height="19" viewBox="0 0 28 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M0.999939 17.5C2.26214 16.0091 6.35869 11.6256 8.56244 9.25L16.8124 13.375L26.4374 1"
                          stroke="white" stroke-width="2"/>
                    <defs>
                      <linearGradient id="paint0_linear4" x1="13.7187" y1="3.0625" x2="14.7499" y2="17.5"
    ...
    <router-link to="/doctors" class="col-xl-3 col-xxl-3 col-sm-6">
        ...
        <div class="card-body">
          <div class="media align-items-center">
            <div class="media-body">
              ...
              <div class="d-flex flex-wrap">
                <h2 class="fs-40 font-w600 text-white mb-0 me-3">{{ doctorLength }}</h2>
                <div>
                  <svg width="28" height="19" viewBox="0 0 28 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M18.875 9.25C21.0787 11.6256 25.1753 16.0091 26.4375 17.5H1V1L10.625 13.375L18.875 9.25Z"
                          fill="url(#paint0_linear1)"/>
                    <path d="M26.4375 17.5C25.1753 16.0091 21.0787 11.6256 18.875 9.25L10.625 13.375L1 1" stroke="white"
                          stroke-width="2"/>
                    <defs>
                      <linearGradient id="paint0_linear1" x1="13.7188" y1="3.0625" x2="12.6875" y2="17.5"
                                      gradientUnits="userSpaceOnUse">
                        <stop stop-color="white" stop-opacity="0.73" offset="0.1"/>
                        <stop offset="1" stop-color="white" stop-opacity="0"/>
                      </linearGradient>
    ...
    <router-link to="/appointments" class="col-xl-3 col-xxl-3 col-sm-6">
                ...
                <div>
                  <svg width="28" height="19" viewBox="0 0 28 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M26.4375 17.5C25.1753 16.0091 21.0787 11.6256 18.875 9.25L10.625 13.375L1 1" stroke="white"
                          stroke-width="2"/>
                    <defs>
                      <linearGradient id="paint0_linear2" x1="13.7188" y1="3.0625" x2="12.6875" y2="17.5"
                                      gradientUnits="userSpaceOnUse">
                        <stop stop-color="white" stop-opacity="0.73" offset="0.1"/>
                        <stop offset="1" stop-color="white" stop-opacity="0"/>
                      </linearGradient>
    ...
    <router-link to="/consultations" class="col-xl-3 col-xxl-3 col-sm-6">
        ...
        <div class="card-body">
          <div class="media align-items-center">
            <div class="media-body">
              ...
              <div class="d-flex flex-wrap">
                <h2 class="fs-40 font-w600 text-white mb-0 me-3">{{ consultationLength }}</h2>

              </div>
            </div>
            <span class="border rounded-circle p-4 mt-3">
									<svg width="34" height="34" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M12 0C7.03125 0 3 4.03125 3 9C3 11.1562 3.84375 13.1562 5.21875 14.6562L0 24L3.9375 21.0625C6.4375 22.6875 9.28125 23.5 12.2812 23.5C17.25 23.5 21.2812 19.4688 21.2812 14.5C21.2812 9.53125 17.25 5.5 12.2812 5.5C9.84375 5.5 7.65625 6.4375 6.03125 8.0625L9.96875 11.9688C11.0625 10.8438 12.4688 10.1875 14.0312 10.1875C16.2188 10.1875 18 12 18 14.1875C18 16.375 16.2188 18.1875 14.0312 18.1875C12.875 18.1875 11.9062 17.75 11.1562 16.9688H9.25V19.875H14.75V16.9688H12.8438C12.3438 16.4688 12 15.7812 12 15C12 14.2188 12.3438 13.5312 12.8438 13.0312C13.3438 12.5312 14.0312 12.1875 14.8125 12.1875C15.5938 12.1875 16.25 12.5312 16.75 13.0312C17.25 13.5312 17.5938 14.2188 17.5938 15C17.5938 15.7812 17.25 16.4688 16.75 16.9688H18.6875V19.875H14.0312C13.2812 20.6562 12.2812 21 11.1562 21C9.09375 21 7.34375 19.625 6.25 17.9375L2.3125 21.875L5.21875 14.6562C4 13.125 3 11.1875 3 9C3 4.03125 7.03125 0 12 0Z"
                        fill="white"/>
                  </svg>
									</span>
          </div>
...
export default {
  ...
  methods: {
    getDoctors() {
      DoctorDataService.getAllDoctors(this.defaultPage, this.defaultSize)
          .then(response => {
            ...
            this.doctorLength = this.doctors.totalItems;
    ...
    getPatients() {
      PatientDataService.getAllPatients(this.defaultPage, this.defaultSize)
          .then(response => {
            ...
            this.patientLength = this.patients.totalItems;
    ...
    getAdministrators() {
      AdministratorDataService.getAllAdministrator(this.defaultPage, this.defaultSize)
          .then(response => {
            ...
            this.administratorLength = this.administrators.totalItems;
            console.log(this.administratorLength);
    ...
    getConsultations() {
      ConsultationDataService.getAllConsultations(this.defaultPage, this.defaultSize)
          .then(response => {
            this.consultations = response.data;
            this.consultationLength = this.consultations.totalItems;
            console.log(this.consultationLength);
          })
          .catch(e => {
            console.log(e);
          });
