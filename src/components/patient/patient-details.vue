          ...
          <div class="card">
            <div class="card-body">
              <div class="media d-sm-flex d-block text-center text-sm-start pb-4 mb-4 border-bottom">
                <img v-if="patient.gender==='MALE'" alt="image" class="rounded me-sm-4 me-0" width="130" src="../../../public/assets/images/avatar/1.jpg">
                ...
                <div class="media-body align-items-center">
                  ...
                  <a v-if="patient.gender==='MALE'" href="javascript:void(0);" class="btn bgl-primary btn-rounded text-black mb-2 me-2">
              ...
              <div class="row">
                <div class="col-lg-6 mb-2">
                  <div class="media">
                      ...
                      <p class="fs-18 text-dark">{{patient.address}} </p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-6 mb-md-0 mb-2">
                  <div class="media">
                    ...
                    <div class="media-body">
                      ...
                      <p class="fs-18 text-dark font-w600 mb-0">+212 {{patient.phone}}</p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6">
